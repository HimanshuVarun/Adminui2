...
public class CampaignForm extends MethodClass
{
	...
	{           
		...
		logger.info("start campaign method");
		        System.out.println("campaign method is start");
      ...
      //collect data from excel	
                ...
                campaign_count=Hs.getLastRowNum()-4;
	   			...
	   			{    
	   				...
	   				String  campaignspriFix=Hs.getRow(i).getCell(4).getStringCellValue();
		      ...
		      //sel3.selectByVisibleText("server25");
	   			...
	   			//driver.findElement(By.name("campaign_prefix")).sendKeys(campaignspriFix);
			    ...
			    driver.findElement(By.id("cust_disp_3")).sendKeys("multiverifier");
